...
char* our_box(char* k1,char* k2,char* k3,char* k4,char* k5) //initial algo
{
...
char* module(char* k1,char* k2,char* k3,char* k4,char* k5)
{
    char* str=our_box(k1,k2,k3,k4,k5);
    string s=from_charstar_to_string(str);
    string shaout=SHA512(s);
    cout<<shaout<<"\n";
	char* str2=from_string_to_charstar(shaout);
	int len=get_int(k4);
	int sum=0;
	int j=0;
	while(str2[j]!='\0')
...
char* module1(char* k1,char* k2,char* k3,char* k4,char* k5)
{
    ...
    cout<<shaout<<"\n";
	char* str2=from_string_to_charstar(shaout);
	int len=get_int(k4)-4;
	str2[len]='\0';
	return str2;
	
}
char* module2(char* k1,char* k2,char* k3,char* k4,char* k5) //initial algo
{
...
char* get_password(char* k1,char* k2,char* k3,char* k4,char* k5)
{
    char* str=module1(k1,k2,k3,k4,k5);
    char* str2=module2(k1,k2,k3,k4,k5);
...
int main()
{
	...
	char k4[100];
	char k5[100];
	scanf("%s %s %s %s %s ",k1,k2,k3,k4,k5);
	char* ans=our_box(k1,k2,k3,k4,k5);
	printf("%s\n",ans);
	char* ans2=module(k1,k2,k3,k4,k5);
    printf("%s\n",ans2);
	return 0;
}
